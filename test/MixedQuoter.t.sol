    ...
    GasSnapshot
{
    ...
    function testV4CLquoteExactInputSingle_ZeroForOne() public {
        ...
        bytes[] memory params = new bytes[](1);
        params[0] = abi.encode(IMixedQuoter.QuoteMixedV4ExactSingleParams({poolKey: poolKey, hookData: ZERO_BYTES}));
    ...
    function testV4CLquoteExactInputSingle_ZeroForOne_WETHPair() public {
        ...
        bytes[] memory params = new bytes[](1);
        params[0] =
            abi.encode(IMixedQuoter.QuoteMixedV4ExactSingleParams({poolKey: poolKeyWithWETH, hookData: ZERO_BYTES}));
    ...
    function testBinQuoteExactInputSingle_ZeroForOne() public {
        ...
        bytes[] memory params = new bytes[](1);
        params[0] = abi.encode(IMixedQuoter.QuoteMixedV4ExactSingleParams({poolKey: binPoolKey, hookData: ZERO_BYTES}));
    ...
    // V4 CL Pool -> SS Pool
    function testQuoteMixedExactInput_TwoHops_V4Cl_SS() public {
    ...
    function testQuoteMixedExactInput_ThreeHops_V4Cl_SS_V3() public {
    ...
    function testQuoteMixedExactInput_FourHops_V4Cl_SS_V2_V4Bin() public {
        ...
        params[3] = abi.encode(IMixedQuoter.QuoteMixedV4ExactSingleParams({poolKey: binPoolKey, hookData: ZERO_BYTES}));
    ...
    function testQuoteMixedExactInput_ConvertWETHToNative_V3WETHPair_V4CLNativePair() public {
        address[] memory paths = new address[](3);
        paths[0] = address(token2);
        paths[1] = address(weth);
        ...
        params[0] = abi.encode(fee);
        params[1] = abi.encode(
            IMixedQuoter.QuoteMixedV4ExactSingleParams({poolKey: poolKeyWithNativeToken, hookData: ZERO_BYTES})
        );
    ...
    function testQuoteMixedExactInput_ConvertNativeToWETH_V4CLNativePair_V3WETHPair() public {
        address[] memory paths = new address[](3);
        paths[0] = address(token1);
        paths[1] = address(0);
        paths[2] = address(token2);
    ...
    function testQuoteMixedExactOutput_TwoHops_V4Cl_V4Bin() public {
        ...
        bytes[] memory params = new bytes[](2);
        params[0] = abi.encode(IMixedQuoter.QuoteMixedV4ExactSingleParams({poolKey: poolKey2, hookData: ZERO_BYTES}));
        params[1] = abi.encode(IMixedQuoter.QuoteMixedV4ExactSingleParams({poolKey: binPoolKey, hookData: ZERO_BYTES}));
