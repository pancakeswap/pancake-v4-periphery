...
library V3SmartRouterHelper {
    ...
    // bytes32 internal constant V2_INIT_CODE_HASH = 0x57224589c67f3f30a6b0d7a1b54cf3153ab84563bc609ef41dfb34f8b2974d2d; // ETH, GOERLI, SEPOLIA, OPBNB Mainnet, BASE Mainnet, Base Sepolia, Arbitrum sepolia
    // bytes32 internal constant V2_INIT_CODE_HASH = 0xa5934690703a592a07e841ca29d5e5c79b5e22ed4749057bb216dc31100be1c0; // OPBNB Testnet, BASE Testnet
        ...
        pair = address(
            uint160(
                uint256(
                    keccak256(
                        abi.encodePacked(
                            hex"ff", factory, keccak256(abi.encodePacked(token0, token1)), V2_INIT_CODE_HASH
                        )
                    )
                )
            )
    ...
    function getPool(address deployer, address tokenA, address tokenB, uint24 fee)
        public
        pure
